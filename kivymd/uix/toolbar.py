...
class MDToolbar(
    ...
    def __init__(self, **kwargs):
        ...
        if not self.action_icon_color:
            self.action_icon_color = self.specific_text_color
        if not self.text_icon_color:
            self.text_icon_color = self.specific_text_color
    ...
    def on_text_icon_color(self, instance, value):
        self.action_button.text_color = value
